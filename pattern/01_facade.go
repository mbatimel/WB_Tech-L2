...
Минусы: сложный в разработке, есть вероятность превращения в божественный объект(супер-класс) все обращения к методам других классов будут проходить через этот
